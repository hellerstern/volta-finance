...
import VoltaIcon from '../assets/icons/volta-icon.svg'
import WethIcon from '../assets/icons/weth-icon.svg'
import Web3BoostIcon from '../assets/icons/web3-boost-icon.svg'
